@echo off
set CFLAGS=-DSLOW=1 -DINTERNAL=1 -W4 -MT -wd4701 -wd4100 -wd4189 -wd4201 -wd4505 -wd4838 -wd4244 -wd4458 -nologo -Oi -Od -GR- -Gm- -Z7 -EHa 
...
REM Copy Assets
	xcopy /S /Y %SOURCEDIR%data %BUILDDIR% 